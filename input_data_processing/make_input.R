# import functions
setwd('/home/seongwonhwang/Desktop/projects/GRN_in_general/git/GRN_inference_practice/input_data_processing')
...
#############################################
MI <- MakeInput$new('TEST2', path_input, path_tf_and_reqdgenes, path_output)
